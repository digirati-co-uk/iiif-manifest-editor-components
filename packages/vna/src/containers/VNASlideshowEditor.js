...
class VNASlideshowEditor extends React.Component {
  ...
  setEditorMode = (ev, selectedElement) => {
    this.setState({
      ...
      const behaviours = (this.state.rootResource.behavior || []).filter(item=>item!=='vna-slideshow' && item !=='vna-patchwork'); 
      if (selectedElement.props.value !== 'default') {
        behaviours.push('vna-' + selectedElement.props.value);
      }
      this.updateProperty(
        this.state.rootResource, 
        'behavior', 
    ...
    return (
      <MuiThemeProvider theme={theme}>
        ...
        >
          <Layout>
            ...
            <Layout.Middle>
              ...
              <Layout.Right>
                <TabPanel>
                  <IIIFCollectionExplorer url={'http://localhost:8181/p3/'} />
                  <Properties
        ...
        <LoadManifestModal
          ...
          collectionURL={'http://localhost:8181/p3/'}
